<x-layout>
    ...
    <div class="w-full flex items-center justify-between my-6">
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Barang Simpan</h2>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="/items/incoming/create" class="px-3 py-2 text-xs font-medium text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-md cursor-pointer hover:bg-blue-700">
                Tambah Barang Simpan
            </a>
        </div> 
        @endif
    </div>
                    ...
                    @forelse ($incomingItems as $item)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{ \Carbon\Carbon::parse($item->date_of_entry)->locale('id')->isoFormat('dddd, D MMMM Y') }}
                            </td>
                            <td class="px-4 py-3 text-sm">
