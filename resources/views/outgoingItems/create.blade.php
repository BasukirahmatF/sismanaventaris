<x-layout>
    ...
    <div class="w-full flex items-center justify-between my-6">
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Barang Pinjam/Rusak/Tidak Layak</h2>
        <a href="/items/outgoing" class="px-3 py-2 text-xs font-medium transition-colors duration-150 text-blue-500 bg-white border dark:bg-gray-700 dark:text-gray-200 dark:border-gray-700 rounded-md cursor-pointer">
            Kembali
        </a>
    </div>
        ...
        <form action="{{ route('outgoingItems.store') }}" method="POST" class="h-full px-4 py-4 bg-white dark:bg-gray-800">
            ...
            <div class="w-full flex flex-col md:flex-row md:space-x-4">
                <label class="text-sm md:mb-0 w-full md:w-1/2 mb-4">
                    <span class="text-gray-700 dark:text-gray-400">Tanggal Dikeluarkan</span>
