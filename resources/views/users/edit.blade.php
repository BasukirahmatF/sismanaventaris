<x-layout>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs mb-6">
        <form action="{{ route('users.update', ['id' => $user->id]) }}" method="POST" class="h-full px-4 py-4 bg-white dark:bg-gray-800">
            ...
            <button type="submit" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">Save</button>
        </form>
    </div>
