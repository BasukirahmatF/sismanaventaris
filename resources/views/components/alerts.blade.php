@if (session('success'))
<div id="alert" class="absolute mt-4 mr-6 top-4 right-0 flex items-center p-4 mb-6 text-sm font-semibold text-white bg-blue-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-teal">
