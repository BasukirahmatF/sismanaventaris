...
class SupplierController extends Controller {
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('suppliers.index')->with('success', 'Tambah Cabang.');
    }
    ...
    public function update(Request $request, $supplier_code) {
        ...
        return redirect()->route('suppliers.index')->with('success', 'Cabang Update.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('suppliers.index')->with('success', 'Cabang Delete.');
    }
}
