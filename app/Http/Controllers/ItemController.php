...
class ItemController extends Controller {
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('items.index')->with('success', 'Item Ditambah.');
    }
    ...
    public function update(Request $request, $item_code) {
        ...
        return redirect()->route('items.index')->with('success', 'Item Update.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('items.index')->with('success', 'Item Delete.');
    }
}
